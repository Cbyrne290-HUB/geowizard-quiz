...
### Headings
I used a clear heading structure to make GeoWiz feel organized and easy to navigate. By using bold, high-contrast headings for the main titles and smaller weights for the game stats, I created a "path" for the player's eyes to follow. I stuck to proper HTML tags (<h1>, <h2>, etc.) not just for the look, but for accessibility—ensuring screen readers can easily understand the game layout. This keeps the "Pilot Console" looking professional while making sure the most important information, like the question or your score, always stands out.
